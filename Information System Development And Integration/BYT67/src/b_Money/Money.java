...
public class Money implements Comparable {
	...
	public String toString() {
		return String.format("%.2f", (double)amount/100) + " " + currency.getName();
	}
	...
	public Boolean equals(Money other) {
		if((int)other.universalValue() == (int)universalValue()) return true;
		else return false;
	}
	...
	public Money add(Money other) {
		if(other.currency.getName().equals(currency.getName())) {
	...
	public Money sub(Money other) {
		if(other.currency.getName().equals(currency.getName())) {
			...
			int sub = amount - currency.valueInThisCurrency(other.amount, other.currency);
	...
	public int compareTo(Object other) {
		...
		if(equals(otherMoney))return 0;
		else if(universalValue() < otherMoney.universalValue()) return -1;
		else return 1;
	}
}